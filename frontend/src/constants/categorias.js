...
// Importa desde aquí — NO declares arrays locales en cada página.
//
// Espejo de:
//   backend/src/utils/categorias.js
//   tu-mina-mobile/src/utils/categorias.js
//
// Mantener los tres archivos sincronizados manualmente hasta
// que se implemente la Fase 3 (categorías por título, ver CLAUDE.md).
// ============================================================
...
// Diccionarios derivados (lookup O(1)) — útiles cuando una página
// los usa repetidamente dentro de render.
