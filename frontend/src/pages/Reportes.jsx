// anla_minera/frontend/src/pages/Reportes.jsx
    ...
    <div className="tabla-wrapper">
      ...
      {datos.length > maxRows && (
        <div className="tabla-info">
          Mostrando {maxRows} de {datos.length} registros. Exporta a Excel para
          ver todos.
        </div>
      )}
    </div>
...
const Reportes = () => {
    ...
    try {
      ...
      if (res.data.success) {
        ...
        if (res.data.total === 0)
          ...
          setSuccess(
            `✓ ${res.data.total} registro${res.data.total !== 1 ? "s" : ""} encontrado${res.data.total !== 1 ? "s" : ""}`,
          );
      }
    } catch (err) {
  ...
  const setFecha = (campo) => (iso) =>
    setFiltros((prev) => ({ ...prev, [campo]: iso }));
  ...
  const tiposFormularios = [
    ...
    { value: "inventarioMaquinaria", label: "Inv. Maquinaria" },
            ...
            <div className="card-body">
              ...
              <div className="form-grid">
                ...
                <div className="form-group">
                  <label>
                    <FileSpreadsheet size={16} /> Tipo de Formulario
                  </label>
                  <select
                    name="tipo"
                    value={filtros.tipo}
              ...
              {preview.registros.length > 0 ? (
                (() => {
                  ...
                  const renderCell = (row, key) => {
                    if (key === "__creadoPor")
                      return <span className="chip-usuario">{row[key]}</span>;
                    const val = row[key];
                ...
                <div className="estado-vacio">
                  {loading ? (
                    ...
                    <>
                      <Eye size={40} />
                      <p>Selecciona un tipo de formulario para ver los datos</p>
                    </>
                  )}
                </div>
              )}
              ...
              {preview.total > 100 && (
                <div className="info-note">
                  ...
                  <span>
                    ...
                    incluirán los {preview.total} totales.
                  </span>
                </div>
              )}
            </div>
          ...
          <div className="card info-card">
            ...
            <div className="card-body">
              <ol className="instruction-list">
                <li>
                  Selecciona el tipo de formulario — la tabla se actualiza
                  automáticamente
                </li>
                <li>
                  Filtra por fecha escribiendo (dd/mm/aaaa) o con el ícono 📅
                </li>
                <li>Combina usuario, estado y fechas para afinar resultados</li>
                <li>
                  Excel: datos limpios sin formato · PDF: reporte institucional
                  con logo
                </li>
              </ol>
            </div>
