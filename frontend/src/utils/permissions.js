...
const PERMISOS = {
  ...
  VER_PAGINA_MAPA:         ["ADMIN", "ASESOR", "JEFE_PLANTA", "OPERARIO"],
  ...
  VER_GESTOR_ARCHIVOS: ["ADMIN", "ASESOR", "TITULAR", "JEFE_PLANTA", "OPERARIO"],
  ...
  VER_ESTADISTICAS_OPERATIVAS:  ["ADMIN", "ASESOR", "TITULAR", "JEFE_PLANTA", "OPERARIO"],

  VER_PAGINA_OPERACION: ["ADMIN", "ASESOR", "TITULAR", "JEFE_PLANTA", "OPERARIO"],
};
