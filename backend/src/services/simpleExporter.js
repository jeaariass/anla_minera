...
class simpleExporter {
  ...
  async exportarProduccion(datos) {
    ...
    worksheet.columns = [
      ...
      {
        header: "Cantidad_material_entra_Plantabeneficio",
        key: "entra",
        width: 35,
      },
      {
        header: "Cantidad_material_sale_Plantabeneficio",
        key: "sale",
        width: 35,
      },
  ...
  async exportarMultiples(datosPorTipo) {
    ...
    if (datosPorTipo.produccion?.length > 0) {
      ...
      ws.columns = [
        {
          header: "Fecha_corte_informacion_reportada",
          key: "fecha",
          width: 30,
        },
        { header: "Mineral", key: "mineral", width: 20 },
    ...
    // PUNTOS DE ACTIVIDAD
    if (datosPorTipo.puntos_actividad?.length > 0) {
      const ws = workbook.addWorksheet("PUNTOS_ACTIVIDAD");
      ws.columns = [
        ...
        { header: "Maquinaria", key: "maquinaria", width: 25 },
        { header: "Volumen_m3", key: "volumen", width: 15 },
